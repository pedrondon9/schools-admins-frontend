        ...
        <Box sx={{ width: "100%" }}>
            <Card  sx={{bgcolor:"#e0e0e0"}}>
                <CardContent >
                    ...
                    <Typography color = "#5900d6" variant="p"sx={{ height: 60,fontSize:20,fontWeight:"600" }} component="div">
                ...
                <CardActions style={{ display: 'flex', justifyContent: 'space-between' }}>
                    {modal}
                    <Button size="small" component={NavLink} to={`/course/${x._id}`}>Mas informacion</Button>

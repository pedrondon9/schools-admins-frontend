...
const VISIBLE_FIELDS = ['nameSend', 'phoneSend','nameAdminRecep','adressGettoRecep','adressGettoSend','phoneAdmin','phoneAdminRecep','nameAdmin' ,'Fecha', 'adressAdmin', 'verifyRecp', 'iva', 'comision', , 'quantSend', 'interesSocio', 'interesGlobal', 'nameRecep', 'phoneRecep', 'adressRecep', 'nameAdmin', , 'fechaA', 'createdAt', 'phoneAdmin', 'acciones', 'Acciones'];
let total = 0
...
export default function DataTableEnvios() {
    ...
    const columns1 = [
        ...
        {
            field: 'nameAdmin',
            headerName: 'Agente enviado',
            width: 140,
            editable: false,
        },
        {
            field: 'phoneAdmin',
            headerName: 'Tel. agente enviado',
            width: 140,
            editable: false,
        },
        {
        ...
        {
            field: 'adressGettoSend',
            headerName: 'Barrio o direc.. envia..',
            width: 120,
            editable: false,
        },
        ...
        },
        {
            ...
            headerName:'Tel. caja que ha pag..',
            width: 140,
            editable: false,
        },
        {
        ...
        {
            field: 'adressGettoRecep',
            headerName: 'Barrio o direc.. paga..',
            width: 120,
            editable: false,
        },
        {
                ...
                return (
                    <>
                        {verificars ?
                            ...
                            :
                            <Box>
                                <Typography sx={{ color: "#d50000", textAlign: "center", marginTop: '10px' }} variant='p'>
                                    Pendiente
                                </Typography>
                            </Box>
                        }
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                return (
                    <>
                        {!verificars ?
                            <FormUpdateEnvio dataUser={currentRow} GetData = {GetEnviosCajaMasters}   />
                            :
                            <></>
                        }
                        {!verificars ?
                            <FormDeleteEnvio dataUser={currentRow} GetData = {GetEnviosCajaMasters} />
                            :
                            <></>
                        }
    ...
    const GetEnviosCajaMasters = async (userId) => {
        ...
        try {
            const res = await AxiosConfigsToken.get(`/obtener_envios_caja_master/${userId}`)

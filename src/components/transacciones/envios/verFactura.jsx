                ...
                return (
                    ...
                    <div className='container-dialog-confirm' >
                        <div id='facturaSend' style={{ marginLeft: 10, marginTop: 0 }} >
                            ...
                            <p style={{ marginBlock: 1, width: "100%" }}><span style={{ fontSize: 12, fontWeight: '700', color: '#000000' }}>Barrio o direc. envia..:</span> <span style={{ fontWeight: "700", color: '#000000', fontSize: 12 }}>{datos.adressGettoSend}</span></p>
                            <p style={{ marginBlock: 1, width: "100%" }}><span style={{ fontSize: 12, fontWeight: '700', color: '#000000' }}>Nombre Agente envia..:</span> <span style={{ fontWeight: "700", color: '#000000', fontSize: 12 }}>{datos.nameAdmin}</span></p>
                            <p style={{ marginBlock: 1, width: "100%" }}><span style={{ fontSize: 12, fontWeight: '700', color: '#000000' }}>Tel.. Agente envia..:</span> <span style={{ fontWeight: "700", color: '#000000', fontSize: 12 }}>{datos.phoneAdmin}</span></p>
                            
                            {datos.adressGettoRecep ?
                                <>
                                    <p style={{ marginBlock: 1, width: "100%" }}><span style={{ fontSize: 12, fontWeight: '700', color: '#000000' }}>Barrio o direc. paga..:</span> <span style={{ fontWeight: "700", color: '#000000', fontSize: 12 }}>{datos.adressGettoRecep}</span></p>
                                    <p style={{ marginBlock: 1, width: "100%" }}><span style={{ fontSize: 12, fontWeight: '700', color: '#000000' }}>Nombre.. Agente paga..:</span> <span style={{ fontWeight: "700", color: '#000000', fontSize: 12 }}>{datos.nameAdminRecep}</span></p>
                                    <p style={{ marginBlock: 1, width: "100%" }}><span style={{ fontSize: 12, fontWeight: '700', color: '#000000' }}>Tel.. Agente paga..:</span> <span style={{ fontWeight: "700", color: '#000000', fontSize: 12 }}>{datos.phoneAdminRecep}</span></p>
                                </>
                                :
                                <></>
                            }

...
export default function FormUpdate({ dataUp }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      fs.append('imagen1', imagen ? imagen : dataUp.imagenURL);
      ...
      fs.append('contenido1', data.contenido1);
      fs.append('contenido2', data.contenido2);
      fs.append('contenido3', data.contenido3);
  ...
  return (
    ...
    >
      <Button variant="outlined" onClick={handleOpenM} size="small">
        Editar
      </Button>
      <Modal
        open={openM}
              ...
              >
                ...
                >
                  <FormControl sx={{ mb: 2, width: '95%' }}>
                    <TextField
                      ...
                      variant="outlined"
                      defaultValue={dataUp.contenido1}
                      {...register('contenido1', { required: false })}
                    />
                  </FormControl>
                </div>
                <div
                ...
                >
                  <FormControl sx={{ mb: 2, width: '95%' }}>
                    <TextField
                      ...
                      variant="outlined"
                      defaultValue={dataUp.contenido2}
                      {...register('contenido2', { required: false })}
                    />
                  </FormControl>
                </div>
                <div
                ...
                >
                  <FormControl sx={{ mb: 2, width: '95%' }}>
                    <TextField
                      ...
                      variant="outlined"
                      defaultValue={dataUp.contenido3}
                      {...register('contenido3', { required: false })}
                    />
                  </FormControl>
                </div>
                <div
                ...
                >
                  <FormControl sx={{ mb: 2, width: '95%' }}>
                    <TextField
                      ...
                      variant="outlined"
                      defaultValue={dataUp.etiquetas?.toString()}
                      {...register('etiquetas', {
                        required: 'Campo requerido',
                        minLength: 1,
                      })}
                ...
                >
                  <FormControl sx={{ mb: 2, width: '40%' }}>
                    {previImage || dataUp.imagenURL ? (
                      <img src={previImage ? previImage : dataUp.imagenURL} alt="" />
                    ) : (
                      <></>
                    )}
                  </FormControl>

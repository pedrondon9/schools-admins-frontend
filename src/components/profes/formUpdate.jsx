...
export default function FormUpdate({dataUp}) {
    ...
    return (
        <Box sx={{ height: "auto", width: '100%', marginBottom: "10px", display: "flex", justifyContent: "start" }}>
            <Button
                variant="text"
                onClick={handleOpenM}
                size='small'
            ...
            >
                <Box sx={style}>
                    <Typography variant='h6' sx={{ textAlign: "center", marginBottom: 2, color: "textColorTitle" }}>actualizar profesor</Typography>
                                ...
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                                    <FormControl sx={{ mb: 2, width: "95%" }}>
                                        <TextField
                                            ...
                                            variant="outlined"
                                            {...register("info", { required: "Campo requerido", minLength: 1 })}
                                        />
                                    </FormControl>
                                </div>
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>

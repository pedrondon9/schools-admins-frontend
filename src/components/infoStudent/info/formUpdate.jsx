...
export default function FormUpdate({ dataUp }) {
    ...
    return (
        <Box sx={{ height: "auto", width: '100%', marginBottom: "10px", marginTop: '20px', display: "flex", justifyContent: "center" }}>
            <Button
                variant="outlined"
                onClick={handleOpenM}
                size='small'
            ...
            >
                <Box sx={style}>
                    <Typography variant='h6' sx={{ textAlign: "center", marginBottom: 2, color: "textColorTitle" }}>Editar</Typography>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} style={{ width: "100%" }}>
                            <Box sx={{ width: "100%", display: "flex", justifyContent: "center", flexDirection: "column" }}>
                                ...
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                                    <FormControl sx={{ mb: 2, width: "95%" }}>
                                        <InputLabel size='small'
                                            id="demo-simple-select-label">Pais</InputLabel>
                                        <Select
                                            size='small'
                                            name='country'
                                ...
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                                    <FormControl sx={{ mb: 2, width: "95%" }}>
                                        <InputLabel size='small'
                                            id="demo-simple-select-label">Ciudad</InputLabel>
                                        <Select
                                            size='small'

                ...
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}  >
                    <Grid sx={{ width: '100%', display: "flex",marginTop:4 }} >
                        <Box sx={{ width: "49%",marginRight:0.2 }}>
                            <Typography color="#6200ea" variant="body2" sx={{ mb: 1, fontWeight: "500", fontSize: 15, textAlign: 'right' }}>
                                Nombre:
                            </Typography>
                            <Typography color="#6200ea" variant="body2" sx={{ mb: 1, fontWeight: "500", fontSize: 15, textAlign: 'right' }}>
                                Apellidos:
                        ...
                        <Box sx={{ width: "49%",marginLeft:0.2 }}>
                            <Typography variant="body2" sx={{ mb: 1, fontWeight: "500", fontSize: 15, textAlign: 'left' }} color="body2">
                                {data.name}
                            </Typography>
                            <Typography variant="body2" sx={{ mb: 1, fontWeight: "500", fontSize: 15, textAlign: 'left' }} color="body2">
                                {data.name2}

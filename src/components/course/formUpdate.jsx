...
export default function FormUpdate({ dataUp }) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setLoad(true)
            const sendData = await axiosConfigs({ url: `/update_course`, method: "post", data })
    ...
    return (
        <Box sx={{marginLeft:1 }}>
            ...
            >
                <Box sx={style}>
                    <Typography variant='h6' sx={{ textAlign: "center", marginBottom: 2, color: "textColorTitle" }}>Editar curso</Typography>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} style={{ width: "100%" }}>
                            <Box sx={{ width: "100%", display: "flex", justifyContent: "center", flexDirection: "column" }}>
                                ...
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                                    <FormControl sx={{ mb: 3, width: "95%" }}>
                                        <TextField
                                            size='small'
                                            id="outlined-basic"
                                            label="Nombre del curso"
                                            variant="outlined"
                                            defaultValue={defautValues.courseName}
                                            {...register("courseName", { required: "Campo requerido", minLength: 1 })}
                                        />
                                    </FormControl>
                                </div>
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                                    <FormControl sx={{ mb: 3, width: "95%" }}>
                                        <TextField
                                            ...
                                            defaultValue={defautValues.description}
                                            variant="outlined"
                                ...
                                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                                    <FormControl sx={{ mb: 3, width: "95%" }}>
                                        <InputLabel size='small' id="demo-simple-select-label">Estado del curso</InputLabel>
                                        <Select
                                            size='small'
                                            labelId="demo-simple-select-label"
                                            id="demo-simple-select"
                                            defaultValue={defautValues.open}

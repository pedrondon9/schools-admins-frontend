...
export default function FormAdd() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      setLoad(true)
      const sendData = await axiosConfigs({ url: `/create_course`, method: "post", data })
  ...
  return (
    <Box sx={{ height: "auto", width: '100%', marginBottom: "10px", display: "flex", justifyContent: "end" }}>
      ...
      >
        <Box sx={style}>
          <Typography variant='h6' sx={{ textAlign: "center", marginBottom: 2, color: "textColorTitle" }}>registrar curso</Typography>
                ...
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                  <FormControl sx={{ mb: 1, width: "95%" }}>
                    <TextField
                      ...
                      variant="outlined"
                      {...register("courseCode", { required: "Campo requerido", minLength: 1 })}
                    />
                  </FormControl>
                </div>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>

...
import { ACCIONES, CODE_USER, ID_USER, LOGIN_SPINNER, NAME_USER, PHONE_USER, PORCENTAGE, RESP_ERROR_LOGIN, SALDO, SALDO_EFECTIVO, TOKEN, TYPE_USER, URL_SERVER, VALIDE_USER } from "../../contexts/constantesVar";
import 'animate.css';
...

                    {
                        <div style={{ width: '95%', marginTop: 20, display: "flex", }}>
                            <Link
                                ...
                                to=''
                                style={{ textAlign: "right", textDecorationLine: "none", fontFamily: 'revert-layer', fontWeight: "700", fontSize: "19px", color: "#3e2723" }}>...Ir en la antigua plataforma (Caja)</Link>
                        </div>
                    }
                </form> 

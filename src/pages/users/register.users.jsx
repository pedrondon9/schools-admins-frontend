...
import { stylesForm, stylesForm2 } from '../../components/form_components/styleForm';
import RegistreForm2 from '../../components/form_components/form/RegistreForm2';
import { Title } from '../../components/textTitle/title';

function RegisterUsers({ setDataOTP, dataOTP, chooseForm }) {
  ...
  return (
    <>
      <Title title="Registrar un usuario" />
